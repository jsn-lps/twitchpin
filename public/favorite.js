...
setTimeout(() => vcount = document.querySelector('[aria-label="Followed Channels"]').children[1].children[0].children[0].children[0].children[0].children[1].children[1], 5000);

//                  num  <--- this is to be mapped for each streamer
// streamersDiv.children[0].children[1].insertBefore(starIcon, vcount)

setTimeout(() => streamersDiv.children[0].children[1].insertBefore(starIcon, vcount), 8000);
